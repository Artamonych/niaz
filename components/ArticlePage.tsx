  ...
  return (
    <div className="shell">
      ...
      <article className={styles.article}>
        ...
        {/*
          Тело статьи. Разметка приходит не от пользователя: её собирает
          scripts/clean-html.ts на сборке контента и оставляет только
          безопасное подмножество тегов — ни скриптов, ни стилей, ни чужих
          обработчиков. Иначе 52 статьи выглядели бы пустыми страницами.
        */}
        {page.body && (
