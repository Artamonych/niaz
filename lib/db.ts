...
/**
 * Попыток с паузой 1, 2, 4 … 64 с — около двух минут. На выкладке 25.09.2026
 * сбой держался ~15 с, и пять попыток (ровно 15 с) прошли впритык.
 */
const PRAGMA_ATTEMPTS = 8;
...
function createClient() {
  ...
  //
  // С повтором: сразу после выкладки база бывает недоступна — до ~15 с, пока
  // отходит от работы контейнера миграций (25.09.2026: SQLITE_IOERR_SHMSIZE
